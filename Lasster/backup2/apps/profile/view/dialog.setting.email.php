...
<div class="modal fade" id="dialog_mailsetting" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_mailsetting" class="form-horizontal" role="form" onsubmit="fn.app.profile.mail.save_setting();return false;">
    	<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-warning pull-left" onclick="fn.app.profile.mail.testserver()">Test Server</button>
