                ...
                <ul class="nav metismenu" id="side-menu">
					...
					foreach($aApplication as $main_menu){
						//if($abox->allow($main_menu['appname'],'view')){
							echo '<li class="'.(isset($main_menu['class'])?$main_menu['class']:"").'">';
								echo '<a href="'.(isset($main_menu['path'])?$main_menu['path']:"#").'" title="'.$main_menu['name'].'"><i class="'.$main_menu['icon'].'"></i> <span class="menu-item-parent">'.$main_menu['name'].'</span></a>';
