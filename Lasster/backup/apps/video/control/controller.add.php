<?php
	include_once "apps/video/view/dialog.add.php";
?>
<script style="text/javascript">
	fn.app.video.add = function(){
	...
	$("#video .itoolbar").append('<button id="btnAdd" type="button" class="btn btn-primary pull-right">Add</button>');
