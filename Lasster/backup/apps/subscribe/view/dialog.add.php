...
<div class="modal fade" id="dialog_add" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_add" class="form-horizontal" role="form" onSubmit="fn.app.job.add();return false;">
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea rows="6" type="text" class="form-control" id="txtjob" name="txtjob"></textarea>
					</div>
				</div>
				<div class="form-group">
