<?php
	...
	$aColumns = array('products.id','products.name','products.type','products.price','products.discount','product_detail.photo','products.status','products.id');
	$sIndexColumn = "products.id";
	
	$sTable = "products
	LEFT JOIN product_detail ON products.detail = product_detail.id";
	$sLimit = "";
