<?php
	...
	$blog = $dbc->GetRecord("blog","*","id=".$_REQUEST['id']);
	// $photo = $blog['image'];
...
<div class="modal fade" id="dialog_edit" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_edit" class="form-horizontal" role="form" onSubmit="fn.app.blog.save_change();return false;">
    	...
    	<div class="modal-content">
			...
			<div class="modal-body">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#PhotoEdit" aria-controls="PhotoEdit" role="tab" data-toggle="tab">Photo In Slide</a></li>
				</ul>
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="profileEdit">
						<br>	
					...
					<div role="tabpanel" class="tab-pane" id="PhotoEdit">
						<br>
						<div class="form-group">
							<div class="col-xs-12 col-sm-12 col-md-12 text-center">
								<div class="col-xs-12 col-sm-12 col-md-12 text-center">
