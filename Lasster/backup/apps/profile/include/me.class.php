...
class meClass{
	...
	private $header_meta = array(
		...
		array('edit'		,"Edit Profile",	'fa fa-edit fa-2x'),
		//array('message'		,"Messages",	'fa fa-envelope fa-2x'),
		//array('notification',"Notification",	'fa fa-bell fa-2x')
	);
	...
	function PageHeader($active){
		echo '<div id="breadcrumb">';
			echo '<ul class="breadcrumb">';
				...
				echo ' <li></i><a href="?app='.$this->app.'"> Profile</a></li>';
