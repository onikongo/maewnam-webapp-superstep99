	...
	<div class="wrapper-page">
		<div class="panel panel-color panel-inverse">
			<div class="panel-heading"> 
			   <h3 class="text-center m-t-10"> Sign In to <strong>SuperStep99</strong> </h3>
			</div> 

			<div class="panel-body">
				<form class="form-horizontal m-t-10 p-20 p-b-0" onsubmit="sign_in()">
					...
					<div class="form-group text-right">
						<div class="col-xs-12">
							<a onclick="sign_in()"><button class="btn btn-success w-md" type="submit">Log In</button></a>
						</div>
					</div>
					<!--
