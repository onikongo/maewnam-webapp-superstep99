...
<div class="modal fade" id="dialog_add_subdistrict" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_addsubdistrict" class="form-horizontal" role="form" onsubmit="fn.app.database.subdistrict.add();return false;">
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="txtName" placeholder="Subdistrict Name">
					</div>
				</div>
		    </div>
